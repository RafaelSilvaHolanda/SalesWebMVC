...
namespace SalesWebMVC.Data {
    public class SeedingService {
        ...
        private Seller[] SeedSellers(Department d1, Department d2, Department d3, Department d4) {
        ...
        private SalesRecord[] SeedSalesRecord(Seller s1,Seller s2,Seller s3, Seller s4, Seller s5, Seller s6) {
