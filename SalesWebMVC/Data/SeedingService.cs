...
namespace SalesWebMVC.Data {
    public class SeedingService {
        ...
        public void Seed() {
            if (DbHasNotBeenSeeded()) {
                SeedAllTables();
            }
        }

        private Boolean DbHasNotBeenSeeded() {
            return !(_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any());
        }

        private void SeedAllTables() {
            Department[] departments = SeedDepartments();
            Seller[] sellers = SeedSellers(departments[0], departments[1], departments[2], departments[3]);
            SalesRecord[] sales = SeedSalesRecord(sellers[0], sellers[1], sellers[2], sellers[3], sellers[4], sellers[5]);

            WriteOnDatabase(departments, sellers, sales);

        }

        private static Department[] SeedDepartments() {
            Department d1 = new("Computers");
            Department d2 = new("Eletronics");
            Department d3 = new("Fashion");
            Department d4 = new("Books");

            return new Department[] { d1, d2, d3, d4 };
        }

        private static Seller[] SeedSellers(Department d1, Department d2, Department d3, Department d4) {
            ...
            Seller s6 = new("Alex Pink", "alexpink@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);

            return new Seller[] { s1, s2, s3, s4, s5, s6 };
        }

        private static SalesRecord[] SeedSalesRecord(Seller s1, Seller s2, Seller s3, Seller s4, Seller s5, Seller s6) {
            ...
            return new SalesRecord[] { r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r28, r29, r30 };
        }
        private void WriteOnDatabase(Department[] departments, Seller[] sellers, SalesRecord[] sales) {
